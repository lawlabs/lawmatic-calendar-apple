...
struct MacContentView: View {
    ...
    private var toolbarContent: some ToolbarContent {
        ...
        ToolbarItem(placement: .principal) {
            ...
            // Естественный размер, а не фиксированная ширина: на macOS 26+ NSSegmentedControl
            // после первой смены выбора перекладывает сегменты под свою собственную ширину
            // (4 × ширина самого длинного заголовка), и при навязанных 250 pt они вылезают
            // за рамку — выделение «Дня» прилипает к левому краю, «Год» уезжает вправо.
            .fixedSize()
